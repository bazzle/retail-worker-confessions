<div class="sidebar__list">
    ...
    foreach($recent_posts as $recent_post) :
        ...
        <?php if ($sc_atts['image'] == "yes") : ?>
            <a href="<?php echo $itemlink ?>" class="sidebar__list__item sidebar__list__item--image">
                <div class="sidebar__list__item__image">
                    <?php echo $itemthumb; ?>
                </div>
                <span class="sidebar__list__item__title">
                    <?php echo $itemtitle; ?>
                </span>
            </a>
        <?php else : ?>
            <a href="<?php echo $itemlink ?>" class="sidebar__list__item sidebar__list__item--noimage">
                <span class="sidebar__list__item__title">
                    <?php echo $itemtitle; ?>
                </span>
            </a>
